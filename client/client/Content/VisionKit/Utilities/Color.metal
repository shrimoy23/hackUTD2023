...
half3 Color::convertYCbCr_toRGB(half2 chroma, half luma)
{
    half3 out;
...
half3 Color::getLightContribution(half3 lightDirection,
...
bool Color::attemptAtomicallyAddHalf(half2 lhs, device atomic_uint *rhs)
{
